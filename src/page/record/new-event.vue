<script>
	...
	export default {
        ...
        methods: {
        	...
        	setCreateCase() {
        		this.createCustomerEventData.incomingPhone = base64.decode(this.$route.params.phone);
        		this.createCustomerEventData.userId = (this.$route.params.customerId !== '0') ? this.$route.params.customerId : '';
        ...
        mounted() {
        	this.phone = base64.decode(this.$route.params.phone);
        }
	};
